...
<head>
	<title>Car Details | ExotiqueCR</title>
	<meta charset="utf-8">
	...
	<section class="ftco-section ftco-car-details">
		<div class="container">
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-6">
						<form name="date-selection" action="../actions/book_a_car_action.php" method="POST"
							...
							<div class="d-flex">
								<div class="form-group flex-fill mr-2">
									<label for="start_datetime" class="label">Select Start date</label>
									<input type="date" class="form-control" name="startDate" id="start_datetime"
										required min="<?php echo date("Y-m-d"); ?>">
								</div>
								<div class="form-group flex-fill ml-2">
									<label for="end_datetime" class="label">Select End date</label>
									<input type="date" class="form-control" name="endDate" id="end_datetime"
										min="<?php echo date("Y-m-d"); ?>" required>
								</div>
							</div>

							<div class="form-group">
								<button type="submit" class="btn btn-secondary py-3 px-4 btn-block">Continue</button>
							</div>
						</form>
					</div>
				</div>
