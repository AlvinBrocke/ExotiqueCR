...
<head>
  <title>Exotique Car Rentals</title>
  <meta charset="utf-8">
  ...
  <section class="ftco-section ftco-no-pt bg-light">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-15 featured-top">
          <div class="row justify-content-center">
            <div class="col-md-15 d-flex align-items-center">
              <div class="services-wrap rounded-right w-100 justify-content-center">
                <h3 class="heading-section mb-15 text-center">Better Way to Rent Your Perfect Cars</h3>
                  ...
                  <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="services w-100 text-center">
                      ...
                      <div class="text w-100">
                        <h3 class="heading mb-2">Enter Your Pickup Details</h3>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                ...
                <p class="text-center"><a href="car.php" class="btn btn-primary py-3 px-4">Search Vehicle</a></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2"><a href="#" class="logo">Exo<span>tique</span></a></h2>
