            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="users.php">Site Users</a>
                        </li>

                    </ul>
                </div>
                <a href="#" class="btn-download" onclick="toggleaddUserForm()">
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php displayAllCustomers(); ?>
                        </tbody>
                    </table>
                </div>
            </div>

            <div class="popup-form-container" id="addUserForm">
                <div class="popup-form">
                    <h4 style="font-weight: bold;">Add User</h4>

                    <button class="close-btn" onclick="closeaddUserForm()">x</button>
                    <form action="../actions/add_user_action.php" method="POST" enctype="multipart/form-data">
